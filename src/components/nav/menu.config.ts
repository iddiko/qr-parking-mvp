...
export const menuConfig: Record<string, MenuItem[]> = {
  ...
  guard: [
    { key: "scan", label: "스캔", href: "/scan" },
    { key: "history", label: "이력", href: "/history" },
  ...
  resident: [
    ...
    { key: "alerts", label: "스캔 알림", href: "/alerts" },
